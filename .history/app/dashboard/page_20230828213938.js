                        ...
                        <div class="container max-w-3xl px-4 mx-auto sm:px-8">
                            <div class="py-8">
                                <div class="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
                                    <div class="inline-block min-w-full overflow-hidden p-8 bg-white rounded-lg shadow">
                                        ...
                                        <table class="min-w-full leading-normal">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-5 flex text-sm bg-white border-gray-200">
                                                        <span className="px-2 py-1 font-semibold text-blue-500 bg-blue-100 rounded-md">
                                                            Signed
                                                        </span>
                                                        <span className="ml-2">
                                                            Today
