                    ...
                    <div className="flex flex-col w-full pl-0 xl:w-2/3 md:p-4 md:space-y-4">
                                ...
                                <div className="mb-4">
                                    <div className="w-full p-4 bg-white shadow-lg rounded-2xl">
                                        ...
                                        <div className="flex items-center ml-10">
                                            <span className="py-2 ml-2 text-3xl font-bold text-black">
                                                $3,200
                                            </span>
                                        </div>
                        ...
                        <div class="min-w-full overflow-hidden py-8 px-16 bg-white rounded-lg shadow">
                            ...
                            <table class="min-w-full leading-normal mt-4">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="py-5 text-sm bg-white border-gray-200">
                                            <div class="flex items-center">
                                                <a
                                                    href="#"
                                        ...
                                        <td class="py-8 flex items-center text-sm bg-white border-gray-200">
                                            <span className="w-16 px-2 py-1 text-xs font-semibold text-center text-blue-500 bg-blue-100 rounded-md">
                                                Signed
                                            </span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-8 flex items-center text-sm bg-white border-gray-200">
                                            <span className="w-20 px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 rounded-md">
                                                Canceled
                                            </span>
