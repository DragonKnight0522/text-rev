...
export default function Dashboard() {
    return (
        <main className="h-screen pt-8 bg-purple">
            <div class="mx-auto max-w-7xl mt-8 h-full bg-gray-100">
                <div class="flex items-start justify-between">
                    <div class="w-full xl:w-1/3 mg-4 bg-white">
                    ...
                    {/* <div class="flex flex-col w-full pl-0 xl:w-2/3 md:p-4 md:space-y-4">
