                        ...
                        <div class="mx-auto">
                            <div>
                                <div class="p-4">
                                    ...
                                    <div class="mt-8 pb-2 text-lg font-bold text-black border-b border-gray-200">
                                        2/5
                                    ...
                                    <tr>
                                        ...
                                        <td class="my-3 pt-3 text-sm bg-white border-gray-200">
                                            <div className="flex -space-x-2">
                                                <a href="#" className="">
                                                    <img
                                                        className="z-10 inline-block object-cover rounded-full w-7 h-7 ring-2 ring-white"
                                                        src="/images/avatars/olivia.jpg"
                                                        alt="Olivia"
                                                    />
                                                </a>
