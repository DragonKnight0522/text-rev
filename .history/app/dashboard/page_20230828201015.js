                        ...
                        <div class="mx-auto">
                            <div>
                                <div class="p-4">
                                    ...
                                    <div class="container flex flex-col items-center justify-center w-full mx-auto bg-white rounded-lg shadow">
                                    ...
                                    <div class="flex items-center my-2 text-xs text-gray-500 divide-y divide">
                                        <svg
                                            width="10"
                                            height="10"
                                            fill="currentColor"
                                    ...
                                    <div class="relative w-full p-4 overflow-hidden bg-white rounded-xl md:w-80">
