                ...
                <div className="flex items-start justify-between h-full">
                    <div className="w-full h-full p-8 bg-white md:w-1/3">
                        ...
                        <div className="mx-auto">
                            <div>
                                <div className="p-4">
                                    <div className="mx-auto mb-4 text-center w-fit opacity-90">
                                    ...
                                    <div className="flex items-center justify-between pt-8 mx-auto w-44">
                                        <span className="relative p-5 bg-green-100 rounded-full">
                                            <svg
                                                ...
                                                width="50px"
                                                fill="currentColor"
                                                className="absolute h-5 text-green-500 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                xmlns="http://www.w3.org/2000/svg"
                                            >
                                                <rect
                                                    fill="none"
                                        ...
                                        <span className="relative p-5 bg-blue-100 rounded-full">
                                            <svg
                                                className="absolute h-5 text-blue-500 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                fill="none"
                                                height="24"
                                                stroke="currentColor"
                                    ...
                                    <div className="pb-2 mt-8 text-lg font-bold text-black border-b border-gray-200">
                                        2/5
                                        <span className="ml-2 font-normal text-gray-400">
                                            Followups
                                        </span>
                                    </div>
                                    <div className="w-full h-2 mb-8 bg-blue-200 rounded-full">
                                        <div className="w-2/5 h-full text-xs text-center text-white bg-blue-600 rounded-full"></div>
                                    </div>
                                    <div className="container flex flex-col items-center justify-center w-full">
                                        <ul className="flex flex-col w-full divide-y divide">
                                            <li className="flex flex-row">
                                                <div className="flex items-center flex-1 py-4 cursor-pointer select-none">
                                                    ...
                                                    <button className="flex justify-end ml-2 text-right">
                                                        <svg
                                                            width="20"
                                                            fill="currentColor"
                                                            height="20"
                                    ...
                                    <div className="flex items-center pb-2 mt-6 text-gray-500 border-b">
                                        <svg
                                            fill="none"
                                            height="24"
                                            viewBox="0 0 24 24"
                                    ...
                                    <div className="relative w-full py-4 overflow-hidden rounded-xl md:w-80">
                                        ...
                                        <div className="flex items-center justify-between mb-6 text-sm rounded">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex flex-col items-start justify-between ml-2">
                                                    Assign to
                                                </div>
                                                <div className="flex items-center">
                                                    <span className="mr-2 rounded-lg">
                                                        <img
                                    ...
                                    <div className="flex items-center justify-between p-4 mb-2 bg-blue-100 rounded-lg">
                                        <div className="flex flex-col items-center justify-center w-10 h-10 mr-4">
                                            <span className="relative p-4 rounded-xl">
                                                <svg
                                                    className="text-blue-500 feather feather-calendar"
                                                    fill="none"
                                                    height="24"
                                                    stroke="currentColor"
                                                    stroke-linecap="round"
                                        ...
                                        <div className="flex-1 pl-1">
                                            <div className="text-xs text-gray-600 font-xs">
                                                Next Appointment
                                            </div>
                    ...
                    <div className="flex flex-col w-full pl-0 xl:w-2/3 md:p-4 md:space-y-4">
                        <header className="flex justify-between text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
                            <ul className="flex flex-wrap -mb-px">
                                <li className="mr-2">
                                    <a
                                        href="#"
                                        className="inline-block p-4 text-purple-600 border-b-2 border-purple-600 rounded-t-lg"
                                    >
                                        Overview
                                    </a>
                                </li>
                                <li className="mr-2">
                                    <a
                                        href="#"
                                        className="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-purple-600 hover:border-purple-600 "
                                        aria-current="page"
                                    >
                                        Inventory
                                    </a>
                            ...
                            <span className="relative p-5 mb-3 bg-blue-500 rounded-full">
                                <svg
                        ...
                        <div className="p-4 bg-white shadow-lg rounded-2xl">
                            <div className="flex flex-row items-center justify-center gap-4">
                                ...
                                <button
                                    type="button"
                                    className="px-4 py-2 text-base font-semibold text-center text-white transition duration-200 ease-in bg-blue-500 rounded-full shadow-md hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 min-w-fit"
                                >
                                    Book Move
                                </button>
                            </div>
                        ...
                        <div className="min-w-full px-16 py-8 overflow-hidden bg-white rounded-lg shadow">
                            <div className="flex items-center justify-between my-4 rounded">
                            ...
                            <table className="min-w-full mt-4 leading-normal">
                                <thead>
                                    <tr>
                                        <th
                                            scope="col"
                                            className="pt-8 pb-2 text-xs font-normal text-left text-gray-500 bg-white border-b border-gray-200"
                                        >
                                            ID
                                        </th>
                                        <th
                                ...
                                <tbody>
                                    <tr>
                                        <td className="pt-3 my-3 text-sm bg-white border-gray-200">
                                            <div className="flex items-center">
                                                <a
                                                    href="#"
                                                    className="relative block font-bold text-blue-500"
                                                >
                                                    #28842
                                                </a>
                                            </div>
                                        ...
                                        <td className="flex items-center pt-3 my-3 text-sm bg-white border-gray-200">
                                    ...
                                    <tr>
                                        <td className="my-3 text-sm bg-white border-gray-200">
                                            <div className="flex items-center">
                                                <a
                                                    href="#"
                                                    className="relative block font-bold text-blue-500"
                                        ...
                                        <td className="flex items-center my-3 text-sm bg-white border-gray-200">
